...
@with_retry
async def _answer(question: str, context: str, language: str = "English") -> str:
    ...
    resp = await client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content":
             ...
             f"descriptions. Be concise (2-3 sentences). Write the answer in {language}."},
...
async def answer(project_id: str, user_question: str,
                 language: str = "English") -> ChatResponse:
    s_cfg = get_settings()
    ...
    answer_text = await _answer(user_question, context, language)
